...
# メイン関数
def main(api_key, stations, year, quarters, age_ranges, area_ranges):
    ...
    with pd.ExcelWriter(desktop_path, engine='xlsxwriter') as writer:
        for station in stations:
            station_code = station["駅コード"]
            station_name = station["駅名"]
            all_results = []
...
if __name__ == '__main__':
    ...
    main(api_key, stations, year, quarters, age_ranges, area_ranges)
